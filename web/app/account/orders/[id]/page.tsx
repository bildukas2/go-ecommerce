  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        {isBankTransfer && (
          <div className="rounded-2xl border border-blue-300 bg-blue-50 p-5 dark:border-blue-700 dark:bg-blue-950/30 md:col-span-2">
            <div className="mb-3 flex items-center gap-2">
              ...
              <h2 className="font-semibold text-blue-900 dark:text-blue-200">How to Pay</h2>
            </div>
            {payment.instructions && (
              <p className="mb-4 text-sm text-blue-800 dark:text-blue-300">{payment.instructions}</p>
            )}
            {bankFields.length > 0 && (
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                {bankFields.map((field) => (
                  <div key={field.label} className="rounded-lg bg-white/60 px-3 py-2 dark:bg-blue-900/30">
                    <p className="text-xs text-blue-600 dark:text-blue-400">{field.label}</p>
                    <p className="font-mono text-sm font-medium text-blue-900 dark:text-blue-100">{field.value}</p>
                  </div>
                ))}
              </div>
            )}
