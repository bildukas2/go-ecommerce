  ...
  return (
    <div className="hero-aurora mx-auto max-w-md px-6 py-10">
      <div className="rounded-2xl border border-surface-border bg-surface/95 p-8 shadow-[0_18px_48px_rgba(2,6,23,0.14)]">
        <h1 className="text-[46px] font-semibold leading-none tracking-tight text-foreground">{t("title")}</h1>
        <p className="mt-4 text-[30px] font-medium text-foreground">{t("welcome")}</p>
        <div className="mt-6">
