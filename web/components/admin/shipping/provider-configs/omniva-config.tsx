    ...
    <div className="space-y-4">
      <div className="rounded-lg border border-blue-500/30 bg-blue-500/5 p-3">
        ...
        <p className="mt-1 text-xs text-foreground/60">
          Enter your Omniva API credentials. These are stored securely in the database.
        </p>
      </div>
      ...
      <label className="space-y-1 text-sm">
        ...
        <input
          ...
          placeholder="Your Omniva API username"
      ...
      <label className="space-y-1 text-sm">
        ...
        <div className="relative">
          <input
            ...
            placeholder="Your Omniva API password"
      ...
      <label className="space-y-1 text-sm">
        ...
        <input
          ...
          placeholder={mode === "sandbox" ? "https://sandbox.omniva.lt/api" : "https://api.omniva.lt"}
